...
knit_table(df=schema,context="estate",caption="Métadonnées descriptives de l'exploitation")
```
...
knit_table(df=schema,context="plot",caption="Métadonnées descriptives de la parcelle expérimentale")
```
